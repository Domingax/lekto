...
export function ContinueReadingCard({ book, chapterTitle, progressPct, onResume }: Readonly<ContinueReadingCardProps>) {
  return (
    <div className="flex items-center gap-4 w-full min-h-[96px] px-4 py-3 bg-amber-50 border border-amber-200 rounded-lg">
      <button
        className="flex items-center gap-4 flex-1 min-w-0 cursor-pointer text-left rounded-lg"
